...
* **Dual Query Modes:**
    * **Natural Language:** Users can ask questions like "Show total sales by region." The app uses Google Gemini (via LangChain) to interpret the schema (provided in markdown format along with natural language user query) and generate the corresponding SQL query.
